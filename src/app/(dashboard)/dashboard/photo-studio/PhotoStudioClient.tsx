      ...
      <div className="bg-white dark:bg-zinc-900 rounded-2xl shadow-sm border border-gray-200 dark:border-zinc-800 overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 p-8">
          ...
          <div className="space-y-4">
            ...
            {/* Image Result */}
            <div className="w-full aspect-square border border-gray-200 dark:border-zinc-700 rounded-xl flex items-center justify-center bg-gray-50 dark:bg-zinc-800 relative overflow-hidden">
              {isLoading && (
                <div className="flex flex-col items-center justify-center h-full space-y-4">
                  {/* Animated gradient background */}
                  <div className="absolute inset-0 bg-linear-to-br from-emerald-50 via-blue-50 to-purple-50 dark:from-emerald-950 dark:via-blue-950 dark:to-purple-950 animate-pulse"></div>

                  {/* Main spinner with glow effect */}
                  <div className="relative z-10">
                    <div className="absolute inset-0 blur-xl bg-emerald-400 opacity-30 animate-pulse"></div>
                    <svg
                      className="animate-spin h-16 w-16 text-emerald-600 dark:text-emerald-400 relative z-10"
                      viewBox="0 0 24 24"
                    >
                      <circle
                        className="opacity-25"
